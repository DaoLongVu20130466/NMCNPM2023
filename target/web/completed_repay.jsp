...
<section class="hot-deal-area section-gap">
    <div class="container">
        ...
        <div class="container et-main-content" ng-show="!bannerTet">
            ...
            <!-- Bước 5. Hệ thống ghi nhận hoàn tất giao dịch. -->
            <!-- Bước 6. Nhân viên baán vé cung cấp vé tàu đã được trả lại cho nhà vận chuyển -->
            <div class="col-md-12 hidden-print">
                <div class="row et-page-header">
                    <span class="et-main-label ng-binding">HOÀN TẤT GIAO DỊCH<!--TRẢ VÉ TRỰC TUYẾN--></span>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div>
                        <p class="alert alert-info">
                            Trả vé thành công, lệ phí trả vé là <%=bill.getTotalPrice()*0.1%>,
                            sồ tiền trả lại là <%=bill.getTotalPrice()*0.9%> sẽ được hoàn trả vào số tài khoản của quý khách!
                            <br>
